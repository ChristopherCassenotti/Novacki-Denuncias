            ...
            async (tx) => {
                await tx.report_attachments.create({
                    data: {
                        ...
                        /*
                         * Sem antivírus externo: o arquivo já passou
                         * pelas validações locais de tipo, extensão e
                         * assinatura binária e fica disponível de imediato.
                         * Mantemos CLEAN por compatibilidade com o contrato
